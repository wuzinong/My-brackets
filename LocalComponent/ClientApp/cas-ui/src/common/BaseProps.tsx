 ...
 */
export type BasePropStyles = Pick<
	React.CSSProperties,
	'margin' | 'marginLeft' | 'marginRight' | 'marginTop' | 'marginBottom' | 'transform'
>;
...
export function attributesFromBaseProps(props: BaseProps, initialStyles?: React.CSSProperties): any {
	...
	const attr = props.attr ? { ...props.attr } : {};
	const style = stylesFromBaseProps(props, initialStyles);
	return {
		...attr,
